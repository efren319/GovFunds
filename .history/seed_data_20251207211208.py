...
from models import Project, Feedback, RegionBudget, ProjectSectorBudget, AnnualBudget
        ...
        try:
            ...
            projects = [
                Project(
                    ...
                    project_sector='Road Infrastructure',
                ...
                Project(
                    name='Public Building Construction',
                    project_sector='Public Buildings',
                ...
                Project(
                    name='Bridge Repair and Maintenance',
                    project_sector='Bridge Infrastructure',
                    description='Structural repair of aging bridge',
                ...
                Project(
                    ...
                    project_sector='Water Resources and Irrigation',
                    description='Small-scale irrigation facility',
            ...
            sector_budgets_2023 = [
                ProjectSectorBudget(sector='Road Infrastructure', year=2023, budget=116252873000),
                ProjectSectorBudget(sector='Bridge Infrastructure', year=2023, budget=29333447000),
                ProjectSectorBudget(sector='Flood Control and Drainage', year=2023, budget=182989695000),
                ProjectSectorBudget(sector='Public Buildings', year=2023, budget=79409974000),
                ProjectSectorBudget(sector='Water Resources and Irrigation', year=2023, budget=15413692000),
                ProjectSectorBudget(sector='Special Infrastructure Projects', year=2023, budget=388286983000),
                ProjectSectorBudget(sector='Disaster Response and Rehabilitation', year=2023, budget=11000000000),
                ProjectSectorBudget(sector='Local Infrastructure Support', year=2023, budget=37285405000),
            ]
            db.session.add_all(sector_budgets_2023)
            
            # Project Sector Budget Data for 2024
            sector_budgets_2024 = [
                ProjectSectorBudget(sector='Road Infrastructure', year=2024, budget=132328352000),
                ProjectSectorBudget(sector='Bridge Infrastructure', year=2024, budget=24755275000),
                ProjectSectorBudget(sector='Flood Control and Drainage', year=2024, budget=244577911000),
                ProjectSectorBudget(sector='Public Buildings', year=2024, budget=100214102000),
                ProjectSectorBudget(sector='Water Resources and Irrigation', year=2024, budget=74903429000),
                ProjectSectorBudget(sector='Special Infrastructure Projects', year=2024, budget=410991162000),
                ProjectSectorBudget(sector='Disaster Response and Rehabilitation', year=2024, budget=1000000000),
                ProjectSectorBudget(sector='Local Infrastructure Support', year=2024, budget=39343250000),
            ]
            db.session.add_all(sector_budgets_2024)
            
            # Project Sector Budget Data for 2025
            sector_budgets_2025 = [
                ProjectSectorBudget(sector='Road Infrastructure', year=2025, budget=541980000000),
                ProjectSectorBudget(sector='Bridge Infrastructure', year=2025, budget=38000000000),
                ProjectSectorBudget(sector='Flood Control and Drainage', year=2025, budget=257060000000),
                ProjectSectorBudget(sector='Public Buildings', year=2025, budget=113522058000),
                ProjectSectorBudget(sector='Water Resources and Irrigation', year=2025, budget=42570000000),
                ProjectSectorBudget(sector='Special Infrastructure Projects', year=2025, budget=330000000000),
                ProjectSectorBudget(sector='Disaster Response and Rehabilitation', year=2025, budget=10000000000),
                ProjectSectorBudget(sector='Local Infrastructure Support', year=2025, budget=25000000000),
            ]
