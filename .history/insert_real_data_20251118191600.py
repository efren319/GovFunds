#!/usr/bin/env python3
"""Insert real budget data from sample_data.txt"""
import psycopg2
...
try:
    ...
    # Insert Real Department Budget Data for 2023
    dept_data_2023 = [
    ...
    for dept_name, year, budget in dept_data_2023:
        cur.execute(
            "INSERT INTO department_budget (department, year, budget) VALUES (%s, %s, %s)",
            (dept_name, year, budget)
        )
    print(f"Inserted {len(dept_data_2023)} department records for 2023")
    
    # Insert Real Department Budget Data for 2024
    dept_data_2024 = [
    ...
    for dept_name, year, budget in dept_data_2024:
        cur.execute(
            "INSERT INTO department_budget (department, year, budget) VALUES (%s, %s, %s)",
            (dept_name, year, budget)
        )
    print(f"Inserted {len(dept_data_2024)} department records for 2024")
    
    # Insert Real Department Budget Data for 2025
    dept_data_2025 = [
    ...
    for dept_name, year, budget in dept_data_2025:
        cur.execute(
            "INSERT INTO department_budget (department, year, budget) VALUES (%s, %s, %s)",
            (dept_name, year, budget)
        )
    print(f"Inserted {len(dept_data_2025)} department records for 2025")
    
    # Insert Real Regional Budget Data for 2023
    region_data_2023 = [
    ...
    for region_name, year, budget in region_data_2023:
        cur.execute(
            "INSERT INTO region_budget (region, year, budget) VALUES (%s, %s, %s)",
            (region_name, year, budget)
        )
    print(f"Inserted {len(region_data_2023)} region records for 2023")
    
    # Insert Real Regional Budget Data for 2024
    region_data_2024 = [
    ...
    for region_name, year, budget in region_data_2024:
        cur.execute(
            "INSERT INTO region_budget (region, year, budget) VALUES (%s, %s, %s)",
            (region_name, year, budget)
        )
    print(f"Inserted {len(region_data_2024)} region records for 2024")
    
    # Insert Real Regional Budget Data for 2025
    region_data_2025 = [
    ...
    for region_name, year, budget in region_data_2025:
        cur.execute(
            "INSERT INTO region_budget (region, year, budget) VALUES (%s, %s, %s)",
            (region_name, year, budget)
        )
    print(f"Inserted {len(region_data_2025)} region records for 2025")
    
    cur.close()
    conn.close()
    print("\n[SUCCESS] All real budget data inserted!")
